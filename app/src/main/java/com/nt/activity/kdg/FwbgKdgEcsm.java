 ...
 *
 */
public class FwbgKdgEcsm extends FrameActivity {
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case Constant.NUM_6:
				...
				SimpleAdapter adapter = new SimpleAdapter(FwbgKdgEcsm.this,
						data_smyy, R.layout.spinner_item, from, to);
				spinner_smyy.setAdapter(adapter);

				adapter = new SimpleAdapter(FwbgKdgEcsm.this, data_sblx,
						R.layout.spinner_item, from, to);
				spinner_sblx.setAdapter(adapter);

				adapter = new SimpleAdapter(FwbgKdgEcsm.this, data_lxdh,
						R.layout.spinner_item, from, to);
			...
			case Constant.NUM_8:
				...
				SimpleAdapter adapter1 = new SimpleAdapter(FwbgKdgEcsm.this,
