...
public class FwbgXgKdg extends FrameActivity {
	...
	protected void initView() {
		...
		findViewById(R.id.ll_btgyy_v).setVisibility(View.VISIBLE);
	}
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case Constant.NUM_6:
				...
				SimpleAdapter adapter = new SimpleAdapter(FwbgXgKdg.this,
						data_smyy, R.layout.spinner_item, from, to);
				spinner_smyy.setAdapter(adapter);

				adapter = new SimpleAdapter(FwbgXgKdg.this, data_sblx,
						R.layout.spinner_item, from, to);
				spinner_sblx.setAdapter(adapter);

				adapter = new SimpleAdapter(FwbgXgKdg.this, data_lxdh,
						R.layout.spinner_item, from, to);
			...
			case Constant.NUM_8:
				...
				SimpleAdapter adapter1 = new SimpleAdapter(FwbgXgKdg.this,
