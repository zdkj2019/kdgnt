...
public class FwbgXgKdgWx extends FrameActivity {
	...
	private String flag, zbh, msgStr, zdh, zbh_xj, xzpj_str, sbxhbm, dlbm,
			zlbm, xlbm, sblx, sbxh, clgcs, sbxlhs, wxts, bzr, lxdh, ywlx2, ds,
			ywhy_bm, ewm = "", hpbm = "", rgfy,wcqkbm;
		...
		if (s.equals("submit")) {// 提交
			try {
				...
				JSONObject json = this.callWebserviceImp.getWebServerInfo(
						"c#_PAD_KDG_ALL", str + "*sql*" + str_xj, DataCache
				...
				if ("2".equals(type)) {// 输入
					...
					bt_wj.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							Intent intent = new Intent(FwbgXgKdgWx.this,ShowImgActivity.class);
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case Constant.NUM_6:
				...
				adapter = new SimpleAdapter(FwbgXgKdgWx.this, data_smyy,
						R.layout.spinner_item, from, to);
				spinner_smyy.setAdapter(adapter);

				adapter = new SimpleAdapter(FwbgXgKdgWx.this, data_sblx,
						R.layout.spinner_item, from, to);
				spinner_sblx.setAdapter(adapter);
				
				adapter = new SimpleAdapter(FwbgXgKdgWx.this, data_wgqk,
						R.layout.spinner_item, from, to);
				...
				adapter = new SimpleAdapter(FwbgXgKdgWx.this, data_lxdh,
						R.layout.spinner_item, from, to);
			...
			case Constant.NUM_8:
				...
				SimpleAdapter adapter1 = new SimpleAdapter(FwbgXgKdgWx.this,
