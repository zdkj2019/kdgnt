 ...
 * 同城普查
 * 
 * @author zdkj 20170412
 */
public class TcpcActivity extends FrameActivity {

	private Button confirm, cancel;
	private Spinner spinner_sf, spinner_ds, spinner_qx;
	private ArrayList<Map<String, String>> data_sf, data_ds, data_qx, data_all;
	private String[] from;
	private int[] to;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		appendMainBody(R.layout.activity_tcpc);
		initVariable();
		initView();
		initListeners();
		showProgressDialog();
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case Constant.SUCCESS:
				...
				break;
			case Constant.NUM_6:
				adapter = new SimpleAdapter(TcpcActivity.this, data_sf,
						R.layout.spinner_item, from, to);
				spinner_sf.setAdapter(adapter);
				break;
			case Constant.NUM_7:
				adapter = new SimpleAdapter(TcpcActivity.this, data_ds,
						R.layout.spinner_item, from, to);
				spinner_ds.setAdapter(adapter);
				break;
			case Constant.NUM_8:
				adapter = new SimpleAdapter(TcpcActivity.this, data_qx,
						R.layout.spinner_item, from, to);
