...
public class ScxjsbxgActivity extends FrameActivity {

	private TextView tv_pz, tv_bjrz,tv_bhyy;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		appendMainBody(R.layout.activity_scxjsbxg);
		initVariable();
		initView();
		initListeners();
		showProgressDialog();
	...
	private void getSbxx() {
		...
		try {
			...
			sbid = (String) itemmap.get("sbid");
			json_sbxx.put("sbid", sbid);
			json_sbxx.put("sbbm", itemmap.get("sbbm"));
			json_sbxx.put("sblx", itemmap.get("sblx"));
			json_sbxx.put("sbxh", itemmap.get("sbxh"));
			json_sbxx.put("sf", itemmap.get("sf"));
			json_sbxx.put("ds", itemmap.get("ds"));
			json_sbxx.put("qx", itemmap.get("qx"));
			json_sbxx.put("wdbm", itemmap.get("wdbm"));
			json_sbxx.put("wdbm_mc", "");
			json_sbxx.put("xxdz", itemmap.get("xxdz"));
			json_sbxx.put("ywhb", itemmap.get("ywhb"));
			json_sbxx.put("sfxz", itemmap.get("sfxz"));
			json_sbxx.put("kzzf10", itemmap.get("kzzf10"));
			loadSbxx();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void loadSbxx() {
		try {
			if (json_sbxx == null) {
				...
				et_xxdz.setText(xxdz);
				tv_bhyy.setText(json_sbxx.getString("kzzf10"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Constant.SUCCESS:
				...
				break;
			case Constant.NUM_6:
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_sf,
						R.layout.spinner_item, from, to);
				spinner_sf.setAdapter(adapter);
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_sblx,
						R.layout.spinner_item, from, to);
				spinner_sblx.setAdapter(adapter);
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_hb,
						R.layout.spinner_item, from, to);
				spinner_hb.setAdapter(adapter);
				getSbxx();
				break;
			case Constant.NUM_7:
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_ds,
						R.layout.spinner_item, from, to);
				...
				break;
			case Constant.NUM_8:
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_qx,
						R.layout.spinner_item, from, to);
			...
			case Constant.NUM_10:
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_wdmc,
						R.layout.spinner_item, from, to);
			...
			case Constant.NUM_12:
				adapter = new SimpleAdapter(ScxjsbxgActivity.this, data_sbxh,
						R.layout.spinner_item, from, to);
			...
			case Constant.NUM_13:
				SimpleAdapter adapter = new SimpleAdapter(ScxjsbxgActivity.this,
