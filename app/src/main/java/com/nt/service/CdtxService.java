...
public class CdtxService extends Service {
	...
	private void query() {
		try {
			...
			JSONObject jsonObject = callWebserviceImp.getWebServerInfo(
					"_PAD_SHGL_KDG_CDTXNR", userid, "uf_json_getdata", this);
...
//				notification.audioStreamType = AudioManager.ADJUST_RAISE;
				...
				intent.putExtra("zbh", json.getString("zbh"));
				...
				PendingIntent pendingIntent = PendingIntent.getActivity(this,
						i, intent, PendingIntent.FLAG_ONE_SHOT);
